...
namespace LED_Editor
{
    public static class Shaders
    {
        ...
        public static void LoadShadersList(string XmlFile, string ShaderPath, bool EngineContent)
        {
            ...
            {
                Debug.WriteLine("Shaders.LoadShadersList() Exception.");
        ...
        public static Shader Load(string Name)
        {
            try
            {
                ...
                {
                    Debug.WriteLine("ShaderProgramInfoLog:");
            ...
            {
                Debug.WriteLine("Shaders.Load() Exception, Name: \"{0}\"", Name);
    ...
    public class Shader
    {
        ...
        public void LoadShader()
        {
            ...
            if (LinkStatus != 1)
            {
                ...
                Debug.WriteLine("Shader Program Error: \"{0}\"", Name);
                Debug.WriteLine("GetProgramInfoLog:\n{0}", InfoLog);
        ...
        string LoadShaderFromFile(String FileName, ShaderType type)
        {
            ...
            {
                Debug.WriteLine("LoadShaderFromFile(\"{0}\") Exception!\n", FileName);
        ...
        static string ShaderInclude(string Str, string FullFileName, string StrBuffer = "")
        {
            ...
            {
                Debug.WriteLine("Shader Include Error!");
                Debug.WriteLine("Shader: {0}", Str);
            }
            return Str;
        }
        ...
        static string DeleteComments(string Str)
        {
            ...
            {
                Debug.WriteLine("Delete Comments Error!\n{0}", e.Message);
                Debug.WriteLine(Str);
            }
            return Str;
        }
