...
namespace LED_Editor
{
    public static class Meshes
    {
        ...
        public static void LoadMeshesList(string XmlFile, string MeshPath, bool EngineContent)
        {
            ...
            {
                Debug.WriteLine("Models.LoadMeshesList() Exception.");
                Debug.WriteLine("XmlFile: \"{0}\", EngineContent: \"{1}\"", XmlFile, EngineContent);
        ...
        public static Mesh Load(string Name, string MeshName)
        {
            ...
            {
                Debug.WriteLine("Meshes.LoadMesh() Exception, Name: \"{0}\"", Name);
                Debug.WriteLine(e.Message);
                return null;
            }
        }
    ...
    public class Mesh
    {
        ...
        public void Load()
        {
            ...
            {
                Debug.WriteLine("Mesh.Load() Exception:");
                Debug.WriteLine("Error in Mesh(Name):\"{0}\" with MeshName: \"{1}\", File: \"{2}\"", Name, MeshName, FileName);
                Debug.WriteLine(e.Message);
            }
        }
    ...
    public class MeshPart
    {
        ...
        static void ComputeTangentBasis(Vector3[] Vertices, Vector3[] Normals, Vector2[] UVs, out Vector3[] Tangents)
        {
            ...
            {
                Debug.WriteLine("MeshPart.ComputeTangentBasis() Exception.");
                Debug.WriteLine(e.Message);
            }
        }
        ...
        static void ReSmoothNormals(ref List<Face> Faces, ref List<Vector3> Normals)
        {
            ...
            {
                Debug.WriteLine("MeshPart.SmoothNormals() Exception:");
        ...
        public static MeshPart[] LoadFromFile(string FileName, bool UseSmoothingGroups = false)
        {
            ...
            {
                Debug.WriteLine("MeshPart.LoadFromFile() FileNotFoundException:");
                Debug.WriteLine("File not found: \"{0}\"\n\"{1}\"", FileName, e.Message);
            }
            catch (Exception e)
            {
                Debug.WriteLine("MeshPart.LoadFromFile() Exception:");
                Debug.WriteLine("Error in file: \"{0}\"\n\"{1}\"", FileName, e.Message);
            }
            return obj;
        }
        ...
        public static MeshPart[] LoadFromString(string obj, bool UseSmoothingGroups = false)
        {
            ...
            {
                Debug.WriteLine("MeshPart.LoadFromString() Exception:");
