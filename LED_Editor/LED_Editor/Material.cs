...
namespace LED_Editor
{
    public static class Materials
    {
        ...
        public static void LoadMaterialsList(string XmlFile, bool EngineContent)
        {
            ...
            {
                Debug.WriteLine("Materials.LoadMaterialsList() Exception.");
        ...
        public static Material Load(string Name)
        {
            ...
            {
                Debug.WriteLine("Materials.Load() Exception, Name: \"{0}\"", Name);
                return null;
            }
        }
    ...
    public class Material
    {
        ...
        public Material(Material Original)
        {
            ...
            for (int i = 0; i < Textures.Length; i++)
                if (Original.Textures[i] != null)
                    Textures[i] = LED_Editor.Textures.Load(Original.Textures[i].Name);
        }
        ...
        public void Free()
        {
            ...
            for (int i = 0; i < Textures.Length; i++)
                LED_Editor.Textures.Unload(Textures[i]);
