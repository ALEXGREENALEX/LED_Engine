    ...
    static public class FBO
    {
        ...
        public static void Init(int ScrWidth, int ScrHeight)
        {
            ...
            if (FramebufferStatus != FramebufferErrorCode.FramebufferCompleteExt)
                Debug.WriteLine("GL.CheckFramebufferStatus: \"FBO_P1\" error {0}", FramebufferStatus.ToString());
            ...
            FramebufferStatus = GL.CheckFramebufferStatus(FramebufferTarget.FramebufferExt);
            if (FramebufferStatus != FramebufferErrorCode.FramebufferCompleteExt)
                Debug.WriteLine("GL.CheckFramebufferStatus: \"FBO_P2\" error {0}", FramebufferStatus.ToString());
            ...
            FramebufferStatus = GL.CheckFramebufferStatus(FramebufferTarget.FramebufferExt);
            if (FramebufferStatus != FramebufferErrorCode.FramebufferCompleteExt)
                Debug.WriteLine("GL.CheckFramebufferStatus: \"FBO_PP\" error {0}", FramebufferStatus.ToString());
        ...
        public static void Draw_P1()
        {
            ...
            if (TempLocation != -1)
            {
                ...
                for (int i = 0; i < L_Directional.Count; i++)
                {
                    ...
                    Vector3 LightDirection = Game.Mult(new Vector4(L_Directional[i].Direction.Normalized(), 0.0f), Game.MainCamera.GetViewMatrix()).Xyz;
                ...
                for (int i = 0; i < L_Point.Count; i++)
                {
                    ...
                    Vector3 LightPosition = Game.Mult(new Vector4(L_Point[i].Position, 1.0f), Game.MainCamera.GetViewMatrix()).Xyz;
                ...
                for (int i = 0; i < L_Spot.Count; i++)
                {
                    ...
                    Vector3 LightPosition = Game.Mult(new Vector4(L_Spot[i].Position, 1.0f), Game.MainCamera.GetViewMatrix()).Xyz;
                    //Vector3 LightDirection = (new Vector4(L_Spot[i].Direction.Normalized(), 0.0f) * Game.MainCamera.GetViewMatrix()).Xyz;
                    Vector3 LightDirection = Game.Mult(new Vector4(L_Spot[i].Direction.Normalized(), 0.0f), Game.MainCamera.GetViewMatrix()).Xyz;
