...
namespace LED_Editor
{
    public static class Textures
    {
        ...
        public static void LoadTexturesList(string XmlFile, string TexturePath, bool EngineContent)
        {
            ...
            {
                Debug.WriteLine("Textures.LoadTexturesList() Exception.");
        ...
        public static void LoadCubemapTexturesList(string XmlFile, string CubemapTexturePath, bool EngineContent)
        {
            ...
            {
                Debug.WriteLine("Textures.LoadCubemapTexturesList() Exception.");
                Debug.WriteLine("XmlFile: \"{0}\", EngineContent: \"{1}\"", XmlFile, EngineContent);
                Debug.WriteLine(e.Message);
            }
        }
    ...
    public class Texture
    {
        ...
        public void Load_Texture2D()
        {
            ...
            {
                Debug.WriteLine("Error: Cannot load Texture (\"{0}\") from File: \"{1}\".", Name, File);
                Debug.WriteLine(e.Message);
                Free();
            }
        }
        ...
        public void Load_Texture2D(Bitmap Image)
        {
            ...
            {
                Debug.WriteLine("Error: Cannot load texture. Name: \"{0}\".", Name);
                Debug.WriteLine(e.Message);
                Free();
            }
        }
        ...
        public void Load_TextureCubemap()
        {
            ...
            {
                Debug.WriteLine("Error: Cannot load CubemapTexture \"{0}\" from Files:", Name);
                for (int i = 0; i < CubemapFiles.Length; i++)
                    Debug.WriteLine("File{0}: \"{1}\"", i, CubemapFiles[i]);
                Debug.WriteLine(e.Message);
                Free();
            }
        }
        ...
        public void Load_TextureCubemap(Bitmap[] CubemapTextures)
        {
            ...
            {
                Debug.WriteLine("Error: Cannot load CubemapTexture. Name: \"{0}\".", Name);
                Debug.WriteLine(e.Message);
                Free();
            }
        }
