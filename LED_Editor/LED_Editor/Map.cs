    ...
    public static class Maps
    {
        ...
        public static void LoadMapList(string MapPath, bool EngineContent)
        {
            ...
            for (int i = 0; i < Maps.Length; i++)
            {
                ...
                {
                    Debug.WriteLine("Maps.LoadMapList() Exception.");
                    Debug.WriteLine("XmlFile: \"{0}\", EngineContent: \"{1}\"", Maps[i], EngineContent);
                    Debug.WriteLine("Maybe some XML file in Map directory is not a valid map.");
        ...
        public static void LoadMap(string MapName = "")
        {
            ...
            {
                Debug.WriteLine("Map \"{0}\" loading Error!\n\t", MapName);
            }
        }
