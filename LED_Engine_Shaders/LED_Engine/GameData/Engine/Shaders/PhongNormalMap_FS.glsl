...
void main()
{
	...
	MaterialInfo Material2 = Material;
	Material2.Kd = DiffuseMap;
	//#include("Light\Func_FS.glsl")
	vec3 LightResult = PhongModel(f_LightDir, f_ViewDir, NormalMap, Light, Material2);
