    ...
    public static class Engine
    {
        public static void LoadConfig()
        {
            try
            {
                ...
                Log.WriteLine("Loading settings from \"Config.xml\".");
            ...
            {
                Log.WriteLineRed("Engine.LoadConfig() Exception.");
        ...
        public static void LoadContentLists()
        {
            try
            {
                ...
                for (int i = 0; i < Paths.Length; i++)
                {
                    ...
                    Models.LoadMeshesList(MeshesConfigs[i], MeshesPaths[i], EngineContent);
