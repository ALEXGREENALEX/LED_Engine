...
namespace Example
{
    class Game
    {
        ...
        static QFontDrawing controlsDrawing;

        static Stopwatch _stopwatch;
        static ProcessedText _processedText;
        static QFont _benchmarkResults;
        static Matrix4 _projectionMatrix;

        #region string constants
        static String modernQuickFontIntro =
        ...
        static String modernIntroCode = @"myFont = new QFont(""Fonts/HappySans.ttf"", 72, new QFontBuilderConfiguration(true));" + Environment.NewLine +
        ...
        static String usingQuickFontIsSuperEasy = @"Using QuickFont is super easy. To load a font: ";
        static String loadingAFont1 = "myFont = new QFont(\"HappySans.ttf\", 16);";
        static String andPrintWithIt = @"...and to print with it: ";
        static String printWithFont1 = "mainText.Begin();" + Environment.NewLine + "myFont.Print(\"Hello World!\")" + Environment.NewLine + "mainText.End();";
        static String itIsAlsoEasyToMeasure = "It is also very easy to measure text: ";
        static String measureText1 = "var bounds = myFont.Measure(\"Hello World\"); ";

        static String oneOfTheFirstGotchas = "One of the first \"gotchas\" that I experienced with the old TextPrinter was having to manage a private font collection. Unlike TextPrinter, QuickFont does not need the private font collection (or Font object for that matter) to exist after construction. QuickFont works out everything it needs at load time, hence you can just pass it a file name, it will load the pfc internally and then chuck it away immediately. If you still prefer to manage a font collection yourself, and you simply want to create a QuickFont from a font object, that's fine: QuickFont has a constructor for this:  ";
        static String loadingAFont2 = "myFont = new QFont(fontObject);";
        ...
        static String printWithFont2 = "myFont.Print(\"Hello World!\",QFontAlignment.Right)";
        ...
        static String textureFontCode3 = "myTexureFont = QFont.FromQFontFile(\"myTextureFont.qfont\");";

        static String asIhaveleant = "As I have learnt, trying to create drop-shadows as part of the glyphs themselves gives very poor results because the glyphs become larger than usual and the font looks poor when printed. To do drop-shadows properly, they need to be rendered separately underneath each glyph. This is what QuickFont does. In fact it does a lot more: it will generate the drop-shadow textures for you. It's super-easy to create a font with a drop-shadow: ";
        static String dropShadowCode1 = "myFont = new QFont(\"HappySans.ttf\", 16, new QFontBuilderConfiguration(true));";
        static String thisWorksFine = "This works fine for texture fonts too: ";
        static String dropShadowCode2 = "myTexureFont = QFont.FromQFontFile(\"myTextureFont.qfont\", new QFontLoaderConfiguration(true));";
        static String onceAFont = "Once a font has been loaded with a drop-shadow, it will automatically be rendered with a shadow. However, you can turn this off or customise the drop-shadow in myFont.options when rendering (I am rotating the drop shadow here, which looks kind of cool but is now giving me a headache xD). I've turned drop-shadows on for this font on this page; however, they are very subtle because the font is so tiny. If you want the shadow to be more visible for tiny fonts like this, you could modify the DropShadowConfiguration object passed into the font constructor to blur the shadow less severely during creation. ";
        ...
        static String hereIsSomeMono = "Here is some mononspaced text.  Monospaced fonts will automatically be rendered in monospace mode; however, you can render monospaced fonts ordinarily " +
                                "or ordinary fonts in monospace mode using the render option:";
        static String monoCode1 = " myFont.Options.Monospacing = QFontMonospacing.Yes; ";
        static String theDefaultMono = "The default value for this is QFontMonospacing.Natural which simply means that if the underlying font was monospaced, then use monospacing. ";
        ...
        static string preProcessed = "Text can be preprocessed which improves rendering time. This text is preprocessed.";
        static string nonPreProcessed = "Text can be preprocessed which improves rendering time. This text is not preprocessed.";
        #endregion

        static int currentDemoPage = 0;
        static int lastPage = 10;
        static int frameCount = 0;

        static double cnt;
        static double boundsAnimationCnt = 1.0f;
        static QFontRenderOptions monoSpacedOptions;
        static QFontRenderOptions codeTextOptions;
        static QFontRenderOptions mainTextOptions;
        static QFontRenderOptions heading1Options;
        static QFontRenderOptions heading2Options;
        static QFontRenderOptions controlsTextOpts;
        static int _previousPage = -1;

        static string _benchResult = "";

        static QFontAlignment cycleAlignment = QFontAlignment.Left;
        ...
        private static void Main(string[] args)
        {
            ...
            Window = Glfw.CreateWindow(800, 600, "QuickFont GLFW (Pencil.Gaming) Example", GlfwMonitorPtr.Null, GlfwWindowPtr.Null);
        ...
        static void OnUpdateFrame()
        {
            ...
            if (boundsAnimationCnt < 1.0f)
                boundsAnimationCnt += (cnt - old_cnt) * 0.2f;
            else
        ...
        static void PrintComment(string comment, ref float yOffset)
        {
        ...
        static void PrintCommentWithLine(string comment, QFontAlignment alignment, float xOffset, ref float yOffset)
        {
        ...
        static void PrintCode(string code, ref float yOffset)
        {
            yOffset += 20;
